...
import { IncomeMonthFilter } from '@/features/income/components';
import { ExpenseTable } from '@/features/expense/components/ExpenseTable';
import { EditExpenseModal } from '@/features/expense/components/EditExpenseModal';
import { DeleteConfirmDialog } from '@/components/ui/DeleteConfirmDialog';
import type { ExpenseTransaction } from '@/features/expense/types/expense';
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 max-md:p-4">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 m-0 max-md:text-2xl">Daftar Pengeluaran</h1>
      </div>

      {/* Summary Card */}
      <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-6 text-white mb-6 flex items-center gap-4 shadow-lg shadow-red-500/20">
